...
public @interface HasId {
    ...
    public class Validator implements ConstraintValidator<HasId, Employee>  {
        ...
        public boolean isValid(final Employee contact, final ConstraintValidatorContext constraintValidatorContext) {
            return contact == null || contact.getEmpId() != 0;
        }
    }

    public class ListValidator implements ConstraintValidator<HasId, List<Employee>>  {
        ...
        @Override
        public boolean isValid(final List<Employee> contacts, final ConstraintValidatorContext constraintValidatorContext) {
            boolean isValid = true;
            for (final Employee contactCard : contacts) {
