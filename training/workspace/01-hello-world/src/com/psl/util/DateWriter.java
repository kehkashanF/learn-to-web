...
public class DateWriter implements MessageBodyWriter<Date> { //jax-rs component class

	@Override
	public long getSize(Date date, Class<?> arg1, Type arg2, Annotation[] arg3,
			MediaType arg4) {
		return -1; //telling jersey to handle computation by itself
	}
