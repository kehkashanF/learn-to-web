		...
		<div class="container">
			<div class="page-header" >
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<li role="presentation"><a href="Fulfilled">Fulfilled</a></li>
					<li role="presentation"><a href="In progress">In progress</a></li>
					<li role="presentation"><a href="Cancelled">Cancelled</a></li>
				</ul>
				</nav>
		...
		<script type="text/javascript" charset="utf-8">
			$(document).ready(function(){
				...
				$('#menu ul li a').click(function(){
					$('#content').load('transaction_display.html #' + $(this).attr('href'));
					return false;
				});
			...
			<div class="we-do-main">
				<div class="we-do-top">
					...
					<iframe src="https://player.vimeo.com/video/24527147" width="500"
