...
<script src="js/HospitalValidation.js">
...
<body>
	...
	<div id="center">
		...
		<h4>Registration Form</h4>
			<form action="HospRegisterValidationController" method="post"
				id="register-form">
				<table align=center>
					<tr>
						<td><label class="sr-only" for="exampleInputEmail3">Hospital
								Name: </label> Hospital Name:</td>
						<td><input type="text" class="form-control" id="hName"
							name="hName" placeholder="Hospital Name" style="width: 300px;"></td>
						</div>
					</tr>
					...
					<tr>
						<div class="form-group">
							<td><label class="sr-only" for="exampleInputEmail3">Officer's
									Name: </label> Officer's Name:</td>
							<td><input type="text" class="form-control" id="oName1"
								name="oName" placeholder="Officer's Name"></td>
						</div>
					</tr>
					...
					<tr>
						<div class="form-group">
							...
							<td><input type="number" class="form-control" id="contact1"
								name="contact" placeholder="Contact No."></td>
						</div>
					</tr>
					...
					<tr>
						<div class="form-group">
							<td><label class="sr-only" for="exampleInputEmail3">Certification:
							</label> Certification:</td>
							<td><input type="text" class="form-control" id="cert1"
								name="cert" placeholder="Certification"></td>
						</div>
					</tr>
					...
					<tr>
						<div class="form-group">
							...
							<td><textarea rows="4" cols="6" class="form-control"
									name="address" id="address1" placeholder="Address"> </textarea></td>
						</div>
					</tr>
					...
					<tr>
						<div class="form-group">
							...
							<td><input type="number" class="form-control" id="pincode1"
