...
public class Main {
			public static void main(String[] args) {
				...
				u1.addContact(c1);
				u1.addContact(c2);
				c1.addProfile(new Profile(2001, 2015));
				c2.addProfile(new Profile(2008, 2015));
				
				u2.addContact(c3);
				c3.addProfile(new Profile(2015, 2025));
					
				u3.addContact(c4);
				u3.addContact(c5);
				u3.addContact(c6);
				
				c4.addProfile(new Profile(2051, 2085));
				c5.addProfile(new Profile(1998, 2005));
				c6.addProfile(new Profile(2014, 2020));
