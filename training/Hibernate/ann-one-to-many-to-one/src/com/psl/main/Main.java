...
public class Main {
			public static void main(String[] args) {
				...
				c3.setAddresses(new HashSet<Address>(Arrays.asList(new Address("LA","USA"),
							new Address("gadhapur","USA"), 
								new Address("sillyville","uae"))));
				...
				Configuration configuration=new AnnotationConfiguration().addAnnotatedClass(User.class).configure();
