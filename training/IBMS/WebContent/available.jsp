							...
							<div class="banner-bottom">
								...
								<div class="bs-example" data-example-id="simple-form-inline">
									...
									<div id="question" class="questionLayer" >
										<br /> <br /> <br /> THANK YOU FOR YOUR RESPONSE!<br /> <br />
										<br />
									</div>
									...
									<form action="CounterServlet" method="post">
										...
										<input class="btn btn-default" type="submit" name="na"
											id="avail" value="Available" onclick="showLayer();">
										<input class="btn btn-default" type="submit" name="na"
											id="navail" value="Not Available" onclick="showLayer();">
									</form>
