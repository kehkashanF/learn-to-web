...
public class Hospital {
	...
	public Hospital(int hospital_id, String hospital_name,
			String hospital_address, int hospital_pin,
			String hospital_password, String hospital_lisenceNo,
			String officer_name, String hospital_email,
			String hospital_certification, String hospital_contactNo) {
		super();
