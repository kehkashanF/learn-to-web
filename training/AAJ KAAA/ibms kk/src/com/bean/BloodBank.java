...
public class BloodBank {
	...
	public String toString() {
		return "BloodBank [bloodBank_id=" + bloodBank_id + ", bloodBank_name="
				+ bloodBank_name + ", bloodBank_address=" + bloodBank_address
				+ ", bloodBank_pin=" + bloodBank_pin + ", bloodBank_circle="
				+ bloodBank_circle + ", bloodBank_telephoneNo="
				+ bloodBank_telephoneNo + ", bloodBank_mobileNo="
				+ bloodBank_mobileNo + ", FDA_lisenceNo=" + FDA_lisenceNo
				+ ", BTO_name=" + BTO_name + ", functional=" + functional
				+ ", bloodBank_emailId=" + bloodBank_emailId
				+ ", bloodBank_password=" + bloodBank_password
				+ ", bloodBank_url=" + bloodBank_url + ", bloodBank_rest_url="
				+ bloodBank_rest_url + "]";
	}
