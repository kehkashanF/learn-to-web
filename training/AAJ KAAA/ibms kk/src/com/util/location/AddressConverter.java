...
public class AddressConverter {
 ...
 public static double getLatitude(String address)throws IOException{
	 GoogleResponse res;
	 double lati=0.0;
 ...
 public static double getLongitude(String address) throws IOException{
	 GoogleResponse res;
	 double longi=0.0;
  ...
  public double calculateDistance(String address1,String address2) throws IOException{
